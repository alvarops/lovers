    ...
    c = c(null, {
        ...
        toJson: function (c) {
            var a = {
                ...
                attributeParameterValues: this.attributeParameterValues && d.toJson(this.attributeParameterValues),
                outSR: this.outSpatialReference ? this.outSpatialReference.wkid || d.toJson(this.outSpatialReference.toJson())  : null,
                ...
                directionsLengthUnits: l.LengthUnit[this.directionsLengthUnits],
                directionsTimeAttributeName: this.directionsTimeAttribute,
                directionsStyleName: this.directionsStyleName,
                travelMode: this.travelMode
            },
            b = this.stops;
            'esri.tasks.FeatureSet' === b.declaredClass && 0 < b.features.length ? a.stops = d.toJson({
                type: 'features',
                features: e._encodeGraphics(b.features, c && c['stops.features']),
                doNotLocateOnRestrictedElements: this.doNotLocateOnRestrictedElements
            })  : 'esri.tasks.DataLayer' === b.declaredClass ? a.stops = b : 'esri.tasks.DataFile' === b.declaredClass && (a.stops = d.toJson({
                type: 'features',
                url: b.url,
                doNotLocateOnRestrictedElements: this.doNotLocateOnRestrictedElements
            }));
            ...
            b = function (a, b) {
                return !a ? null : 'esri.tasks.FeatureSet' === a.declaredClass ? 0 < a.features.length ? d.toJson({
                    type: 'features',
                    features: e._encodeGraphics(a.features, c && c[b])
                })  : null : 'esri.tasks.DataLayer' === a.declaredClass ? a : 'esri.tasks.DataFile' ===
                a.declaredClass ? d.toJson({
                    type: 'features',
                    url: a.url
                })  : d.toJson(a)
        };
